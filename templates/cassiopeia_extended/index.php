...
// Extended template color/font logic
$wa->addInlineStyle(':root {
    --body-bg: ' . $this->params->get('bodybg', 'rgb(254, 254, 254)') . ';
    --body-color: ' . $this->params->get('bodycolor', 'rgb(23, 23, 23)') . ';
    --btnbg: ' . $this->params->get('btnbg', 'rgb(206, 60, 55)') . ';
    --btnbgh: ' . $this->params->get('btnbgh', 'rgb(131, 35, 32)') . ';
    --btncolor: ' . $this->params->get('btncolor', 'rgb(254, 254, 254)') . ';
    --btncolorh: ' . $this->params->get('btncolorh', 'rgb(254, 254, 254)') . ';
    --footerbg: ' . $this->params->get('footerbg', 'rgb(29, 121, 137)') . ';
    --footercolor: ' . $this->params->get('footercolor', 'rgb(254, 254, 254)') . ';
    --headerbg: ' . $this->params->get('headerbg', 'rgb(193, 205, 207)') . ';
    --headercolor: ' . $this->params->get('headercolor', 'rgb(23, 23, 23)') . ';
    --link-color: ' . $this->params->get('linkcolor', 'rgb(29, 121, 137)') . ';
    --link-hover-color: ' . $this->params->get('linkcolorh', 'rgb(14, 59, 67)') . ';
    --body-font-size: ' . $this->params->get('bodysize', '1') . 'rem;
    --h1size: ' . $this->params->get('h1size', '2') . 'rem;
    --h2size: ' . $this->params->get('h2size', '1.7') . 'rem;
    --h3size: ' . $this->params->get('h3size', '1.5') . 'rem;
}');
